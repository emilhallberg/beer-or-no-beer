...
export default function GameScreen() {
  return (
    <div className="h-svh grid grid-rows-[max-content_1fr_max-content]">
      <header className="grid grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center gap-3 rounded-b-3xl border-b-4 border-amber-700 bg-[var(--background)] p-6 pt-4 pb-4">
